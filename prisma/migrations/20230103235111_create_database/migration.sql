/*
  ...
  - You are about to drop the `Employee` table. If the table is not empty, all the use-cases it contains will be lost.
  - You are about to drop the `RegisterQuotation` table. If the table is not empty, all the use-cases it contains will be lost.
  - You are about to drop the `TravelArrangement` table. If the table is not empty, all the use-cases it contains will be lost.
  - You are about to drop the `TravelRegistration` table. If the table is not empty, all the use-cases it contains will be lost.
